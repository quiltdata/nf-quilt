...
export NXF_PLUGINS_TEST_REPOSITORY=https://github.com/quiltdata/nf-quilt/releases/download/0.8.4/nf-quilt-0.8.4-meta.json
nextflow run main.nf -plugins nf-quilt@0.8.4
```
