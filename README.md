...
export NXF_PLUGINS_TEST_REPOSITORY=https://github.com/quiltdata/nf-quilt/releases/download/0.8.1/nf-quilt-0.8.1-meta.json
nextflow run main.nf -plugins nf-quilt@0.8.1
```
